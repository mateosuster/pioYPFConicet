...
tcc_tcp_historico <- read_excel("C:/Archivos/Datos/TCP/tcc_tcp_historico.xlsx") %>% 
...
#     skip = 2)
iso_codes <- read_csv("C:/Archivos/repos/hidrocarburos/analisis/data/world bank/country-and-continent-codes-list-csv.csv")

# all indicators
wb_data <- read_csv("C:/Archivos/repos/hidrocarburos/analisis/data/world bank/API_5_DS2_en_csv_v2_2454210.csv", 
    skip = 3) %>% 
