...
renta_indirecto = merge(renta_indirecto, ipc_promedio[, c("anio", "IPC_18")], by = "anio", all.x = T)
renta_indirecto[,c("Rdifp_crudo","Rdifp_gas" , "Rret", "Rreg",
                   "Rsvx_crudo", "Rsvx_gas", "Subs", "Rtt"  )  :=  lapply(.SD, 
                                                                          function(x) (x*renta_indirecto$IPC_18)*10^6 ),
        .SDcols = c("Rdifp_crudo","Rdifp_gas" , "Rret", "Rreg", 
                    "Rsvx_crudo", "Rsvx_gas", "Subs", "Rtt"  ) ]
renta_indirecto[, unidad := "Pesos corrientes"]
