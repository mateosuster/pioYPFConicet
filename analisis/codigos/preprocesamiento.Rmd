...
expo_usd_crudo[, codigo_variable := fcase( fuente==  "Sec. Energía - SESCO" , "X_crudo_sesco",
                                         ...
                                         fuente==   "UN-Comtrade", "X_crudo_comtrade" ) ]
#impo crudo
impo_crudo= as.data.table(comex_crudo_sesco)
impo_crudo[, producto := NULL]
impo_crudo = impo_crudo[variable == "importacion" & unidad != "ton"]
impo_crudo[,  `:=`  (variable = "Importaciones de petróleo crudo",
                     codigo_variable = "M_crudo_sesco",
                     fuente = "Sec. Energía - SESCO")]

#impo_gas
impo_gas= as.data.table(comex_gas)
impo_gas[, producto := NULL]
impo_gas = impo_gas[variable == "importacion" & unidad != "ton"]
impo_gas[,  `:=`  (variable = "Importaciones de gas natural",
                     codigo_variable = "M_gas_sesco",
                     fuente = "Sec. Energía - SESCO")]
impo_gas[, valor := fcase(unidad == "m3", conversor_m3MMBTU_q(valor) ,
                          unidad == "USD", valor)]
impo_gas[, unidad := fcase(unidad == "m3", "MMBTU" ,
                           unidad == "USD", "USD")]
