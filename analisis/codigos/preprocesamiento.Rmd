...
expo_q_crudo_dt[, variable := "Exportaciones de petróleo crudo"]
...
expo_usd_crudo[, variable := "Exportaciones de petróleo crudo"]
...
expo_usd_gas[, variable := "Exportaciones de gas natural"]
