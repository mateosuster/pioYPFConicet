...
El siguient dataset con variables del mercado hidrocarburífero de largo plazo se elabora a partir del script (preprocesamiento)[https://github.com/mateosuster/pioYPFConicet/blob/main/analisis/codigos/preprocesamiento.Rmd], disponible en nuestro repositorio de GitHub. Esta base de datos también se encuentra publicada en el repositorio (Harvard Datverse)[https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/UTKSOE].
...
Además, se requieren otros datasets para realizar conversiones a dolares de poder adquisitivo constante. Por lo tanto, cargamos los datos del tipo de cambio de paridad y el índice de precios al consumidor de Estados Unidos.
```{r}
#TC
...
Se torna = 0 post 2010, hay que revisar comtrade e INDEC
```{r}
