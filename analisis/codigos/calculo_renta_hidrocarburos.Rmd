...
```{r}
x <- read_excel("../resultados/argentina/renta_comparacion_autores.xlsx") %>% 
...
writexl::write_xlsx(list(sum_mecanismos = renta_indirecto[,c(1:13, 17)],
                         descuentos_vbp = renta_directo, 
                         va_criterio_propio = criterio_propio,
                           sobre_pib_descuentos = renta_directo_pbi[,c(1,14:15)],
                         sobre_pib_mecanismos =renta_indirecto[,c(1,19:20)], 
                         ...
                         comparacion_autores = renta_autores , 
