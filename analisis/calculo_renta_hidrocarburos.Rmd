...
renta_tg <-  tasa_ganancia_rama_flujo %>%
  select(anio, unidad, stock_seleccionado, fuente_pozo, ppye , tasa_ganancia) %>% 
...
renta_indirecto <- renta_dif_precios_crudo %>% 
  ...
  mutate(
    ...
    renta_empresas_desp_impuestos =replace_na(renta_empresas_desp_impuestos,  0),
...
writexl::write_xlsx(list(valor_produccion = valor_total_produccion,
                         metodo_directo_pbi = renta_directo_pbi[,c(1,14:15)],
                         metodo_indirecto_pbi=renta_indirecto[,c(1,19:20)]),
                    path = "resultados/argentina/valor_total_y_renta_pbi.xlsx")
...
writexl::write_xlsx(list( "renta empresas" = renta_empresas_balances,
...
# writexl::write_xlsx(costos_ccnn=costos,
