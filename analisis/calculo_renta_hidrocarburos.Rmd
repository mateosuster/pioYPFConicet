...
## Formulación matemática de estimaciones con criterio propio y criterio CCNN

VBP total
$$VBP_{propia} = (Pext_{petróleo} * Q_{petróleo} + Pext_{gas} * Q_{gas}) * TCP$$

VBP total criterio CCNN
$$VBP_{CCNN} = (Pint_{petróleo} * QMInt_{petróleo} + Pext_{petróleo} * Expo_{petróleo} + Pint_{gas} * QMInt_{gas} + Pext_{gas} * Expo_{gas})* TCC$$

VBP extracción criterio CCNN

$$VBP\_extraccion_{CCNN} = VBP_{CCNN} * (1-prop\_servicios)$$
$$prop\_servicios = \frac{VBP\_servicios_{COU}}{VBP\_extraccion_{COU}}$$
...
* $VBP\extraccion_{CCNN}$ = Valor Bruto de la Producción extracción,  estimación propia con criterio de las CCNN
...
* $prop\_extraccion$ = proporción del VBP de servicios de apoyo sobre VBP de extracción de petróleo y gas
...
Como se mencionó, en todos los casos en los que se presenta dato de consumo intermedio y masa salarial de las CCNN, se realizó el reemplazo de los valores estimados por los datos oficiales de las CCNN.

Consumo Intermedio, valores oficiales de las CCNN:
$$ CI_{CCNN} = VBP_{CCNN} -  VA_{CCNN} $$
Consumo Intermedio, valores estimados bajo criterio de las CCNN:
...
* $CI_{CCNN}$ = Consumo Intermedio, estimación propia
...
$$MS = W * Emp * 13$$
Masa Salarial, valores estimados bajo criterio de las CCNN:
...
$$VA_{propia}  = VBP_{propia} – CI_{CCNN} $$
