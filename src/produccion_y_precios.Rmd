...
# ggsave("../results/argentina/precio_interno_vs_externo.jpg")

data_dif_precios = as.data.table(readxl::read_excel("../results/argentina/renta_de_la_tierra_hidrocarburifera_arg.xlsx",
